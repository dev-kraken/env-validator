 ...
 */ 'handles complex real-world environment configuration', function () {
    ...
    $validator->setRules([
        ...
        'FEATURE_FLAG_NEW_UI' => ['required', \EnvValidator\Collections\StringRules\BooleanRule::class],
        'EXTERNAL_API_URL' => ['required', \EnvValidator\Collections\NetworkRules\UrlRule::class],
    ...
    expect(/**
     * @throws InvalidEnvironmentException
     */ fn () => $validator->validate($realWorldEnv))
